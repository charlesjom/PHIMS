...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_field, class: ['field', 'is-horizontal'],
    hint_class: :field_with_hint, error_class: :field_with_errors, valid_class: :field_without_errors do |b|
  ...
  config.default_wrapper = :horizontal_field
  ...
  config.collection_wrapper_class = 'control'
  ...
  config.label_text = lambda { |label, required, explicit_label| "#{explicit_label ? label : label.titleize} #{required}" }
